...
export class CreationOfTables1767838533804 implements MigrationInterface {
    name = 'CreationOfTables1767838533804'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "properties" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "city" character varying NOT NULL, "culture" character varying NOT NULL, "area" numeric(10,2) NOT NULL, "geometry" jsonb, "obs" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "leadId" integer, CONSTRAINT "PK_2d83bfa0b9fcd45dee1785af44d" PRIMARY KEY ("id"))`);
